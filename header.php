...
<!-- Jasny CSS -->
<link href="<?php bloginfo('template_url') ?>/assets/css/jasny-bootstrap.min.css" rel="stylesheet">
<!-- Animate CSS -->
<link href="<?php bloginfo('template_url') ?>/assets/css/animate.css" rel="stylesheet">
<!-- Code CSS -->
<link href="<?php bloginfo('template_url') ?>/assets/css/tomorrow-night.css" rel="stylesheet" />
<!-- Gallery CSS -->
<link href="<?php bloginfo('template_url') ?>/assets/css/bootstrap-gallery.css" rel="stylesheet">
<!-- ColorBox CSS -->
<link href="<?php bloginfo('template_url') ?>/assets/css/colorbox.css" rel="stylesheet">
<!-- Custom font -->
				...
				<div class="container">
					...
					<div class="collapse navbar-collapse" id="main-nav">
						<ul class="nav navbar-nav" id="filters">
							<li>
								<a href="#" data-filter=".articles" aria-expanded="false" style="font-family: helvetica;">СТАТТІ</a>
							...
							<li>
								<a href="#" data-filter=".video" data-toggle="dropdown" aria-expanded="false" style="font-family: helvetica;">ВІДЕО</a>
								<!-- <ul class="dropdown-menu" role="menu">
							...
							<li>
								<a href="#" data-filter=".anouncments" data-toggle="dropdown" aria-expanded="false" style="font-family: helvetica;">АНОНСИ</a>
								<!-- <ul class="dropdown-menu" role="menu">
